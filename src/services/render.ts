...
<head>
  ...
  <title>${title}</title>
  <meta name="description" content="TypeScript control plane for clause extraction posture, obligation graphs, review blockers, and renewal-safe execution across enterprise agreements. Operator surface in the Kinetic Gain Suite." />
  ...
  <link rel="canonical" href="https://clauses.kineticgain.com/" />
  <link rel="icon" type="image/svg+xml" href="${KG_FAVICON_DATA_URI}" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Kinetic Gain" />
  <meta property="og:title" content="${title}" />
  <meta property="og:url" content="https://clauses.kineticgain.com/" />
  <meta property="og:description" content="TypeScript control plane for clause extraction posture, obligation graphs, review blockers, and renewal-safe execution across enterprise agreements. Operator surface in the Kinetic Gain Suite." />
...
<body>
  <header>
    <div class="wrap nav">
      <a class="kg-logo" href="/" aria-label="Kinetic Gain — TypeScript control plane for clause extraction posture, obligation graphs, review blockers, and renewal-safe execution across enterprise agreements">
        ${KG_MARK_SVG}
        <span class="kg-word">Kinetic Gain</span>
      </a>
      <nav class="nav-links" id="primaryNav">
        <a href="/clause-lane">Clause Lane</a>
        <a href="/obligation-graph">Obligation Graph</a>
        <a href="/review-posture">Review Posture</a>
    ...
    <div class="wrap">
      <div class="foot-top">
        <div>
          ...
          <p class="foot-tag">TypeScript control plane for clause extraction posture, obligation graphs, review blockers, and renewal-safe execution across enterprise agreements — operator surface in the Kinetic Gain Suite. Static demo data; no live calls.</p>
        </div>
        <div class="foot-cols">
          <div class="foot-col">
            <h4>Estate</h4>
          ...
          <div class="foot-col">
            <h4>This surface</h4>
            <a href="https://github.com/mizcausevic-dev/contract-clause-obligation-graph">GitHub repo</a>
          </div>
        </div>
      </div>
      <div class="foot-bot">
