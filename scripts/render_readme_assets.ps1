...
$stdout = Join-Path $env:TEMP ("contract-clause-obligation-graph-" + [guid]::NewGuid().ToString() + "-stdout.log")
$stderr = Join-Path $env:TEMP ("contract-clause-obligation-graph-" + [guid]::NewGuid().ToString() + "-stderr.log")
$port = "5426"
$process = $null
$edgeCandidates = @(
...
try {
    ...
    $targets = @(
        ...
        @{ Url = "http://127.0.0.1:$port/clause-lane"; File = "02-clause-lane-proof.png"; Size = "1600,1320" },
        @{ Url = "http://127.0.0.1:$port/obligation-graph"; File = "03-obligation-graph-proof.png"; Size = "1600,1220" },
        @{ Url = "http://127.0.0.1:$port/review-posture"; File = "04-review-posture-proof.png"; Size = "1600,1220" }
    )
