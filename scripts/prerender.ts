...
import {
  ...
  summary,
  verification
} from "../src/services/contractClauseService";

const OUT = join(process.cwd(), "site");

const pages: Record<string, string> = {
  "index.html": renderOverview(),
  "clause-lane.html": renderClauseLane(),
  "obligation-graph.html": renderObligationGraph(),
  "review-posture.html": renderReviewPosture(),
...
const linkMap: Array<[string, string]> = [
  ...
  ['href="/clause-lane"', 'href="clause-lane.html"'],
  ['href="/obligation-graph"', 'href="obligation-graph.html"'],
  ['href="/review-posture"', 'href="review-posture.html"'],
...
const api: Record<string, unknown> = {
  ...
  "api/clause-lane.json": clauseLane(),
  "api/obligation-graph.json": obligationGraph(),
  "api/review-posture.json": reviewPosture(),
