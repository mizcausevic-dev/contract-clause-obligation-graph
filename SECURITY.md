...
This repository is a **reference control plane** for contract clause extraction,
obligation graphing, review posture, and renewal-safe execution. It ships sample,
non-sensitive data only. It is not a production system of record and should not
be deployed with real contractual or customer data without an independent
security review.
...
(or open a [GitHub security advisory](https://github.com/mizcausevic-dev/contract-clause-obligation-graph/security/advisories/new)).
